                ...
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-blue-600">
                      ...
                      <span className={etfInfo.pct_change >= 0 ? 'text-red-600' : 'text-green-600'}>
                        ({etfInfo.pct_change >= 0 ? '+' : ''}{etfInfo.pct_change?.toFixed(2)}%)
                      </span>
                    </span>
                  </div>
                  <p className="text-xs text-blue-600 mt-1">{etfInfo.management}</p>
                </div>
              )}
