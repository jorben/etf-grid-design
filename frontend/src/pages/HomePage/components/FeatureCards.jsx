  ...
  const features = [
    {
      icon: Cpu,
      title: 'ATR算法核心',
      description: '采用平均真实波幅算法，动态适应市场波动，考虑跳空因素，比传统方法更精确',
      bgColor: 'bg-blue-50',
    ...
    },
    {
      icon: ThermometerSun,
      title: '标的适宜度评估',
      description: '振幅、波动率、市场特征、流动性四个维度量化评分，科学评估标的适宜度',
      bgColor: 'bg-green-50',
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {features.map((feature, index) => (
        <div key={index} className={`text-center p-6 ${feature.bgColor} rounded-lg`}>
