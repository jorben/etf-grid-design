import { formatCurrency, formatPercent, formatDate, formatNumber, formatLargeNumber } from '../format';
...
describe('format utils', () => {
  describe('formatCurrency', () => {
    ...
    test('should handle decimal options', () => {
      ...
      expect(formatCurrency(1234.567, { maximumFractionDigits: 2 })).toBe('¥1,234.57');
    });
  ...
  describe('formatPercent', () => {
    ...
    test('should throw error for invalid input', () => {
      expect(() => formatPercent('invalid')).toThrow('Value must be a valid number');
